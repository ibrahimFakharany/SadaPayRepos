...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        private final ComposeSwipeLibraryAccessors laccForComposeSwipeLibraryAccessors = new ComposeSwipeLibraryAccessors(owner);
        ...
        public ComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getLottie() { return create("compose.lottie"); }
        ...
        /**
         * Returns the group of libraries at compose.swipe
         */
        public ComposeSwipeLibraryAccessors getSwipe() { return laccForComposeSwipeLibraryAccessors; }

    }

    public static class ComposeSwipeLibraryAccessors extends SubDependencyFactory {

        public ComposeSwipeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for refresh (com.google.accompanist:accompanist-swiperefresh)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRefresh() { return create("compose.swipe.refresh"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        private final ComposeSwipeVersionAccessors vaccForComposeSwipeVersionAccessors = new ComposeSwipeVersionAccessors(providers, config);
        public ComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: compose.lottie (4.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLottie() { return getVersion("compose.lottie"); }

            /**
             * Returns the version associated to this alias: compose.shimmer (1.0.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.compose.swipe
         */
        public ComposeSwipeVersionAccessors getSwipe() { return vaccForComposeSwipeVersionAccessors; }

    }

    public static class ComposeSwipeVersionAccessors extends VersionFactory  {

        public ComposeSwipeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: compose.swipe.refresh (0.24.13-rc)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getRefresh() { return getVersion("compose.swipe.refresh"); }
